        ...
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            client.discordTogether.createTogetherCode(member.voice.channel.id, 'wordsnack').then(async invite => {
                let embed = new MessageEmbed()
                    .setAuthor({name: "Word Snack"})
                    .setColor("#FF0000")
                    .setDescription(`
                        You can Play Word Snack with your friends in a Voice Channel. Click *Join Word Snack* to join in!
                        __**[Join Word Snack](${invite.code})**__
