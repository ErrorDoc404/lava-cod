        ...
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            client.discordTogether.createTogetherCode(member.voice.channel.id, 'spellcast').then(async invite => {
                let embed = new MessageEmbed()
                    .setAuthor({name: "Spell Cast"})
                    .setColor("#FF0000")
                    .setDescription(`
                        You can Play Spell Cast with your friends in a Voice Channel. Click *Join Spell Cast* to join in!
                        __**[Join Spell Cast](${invite.code})**__
